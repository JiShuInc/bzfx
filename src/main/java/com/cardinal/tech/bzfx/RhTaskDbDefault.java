在生成代码时，模板发生了如下语法错误：
org.apache.velocity.exception.ParseErrorException: Encountered "> queryById(@PathVariable(\"id\") " at Velocity Code Generate[line 41, column 43]
Was expecting one of:
	...
	at com.bruce.plugin.tool.VelocityUtils.generate(VelocityUtils.java:63)
	at com.bruce.plugin.service.impl.CodeGenerateServiceImpl.generate(CodeGenerateServiceImpl.java:146)
	at com.bruce.plugin.service.impl.CodeGenerateServiceImpl.generate(CodeGenerateServiceImpl.java:105)
	at com.bruce.plugin.service.impl.CodeGenerateServiceImpl.generateByUnifiedConfig(CodeGenerateServiceImpl.java:94)
	at com.bruce.plugin.ui.SelectSavePath.onOK(SelectSavePath.java:217)
	at com.bruce.plugin.ui.SelectSavePath.lambda$new$0(SelectSavePath.java:140)
	...
	at com.bruce.plugin.ui.SelectSavePath.open(SelectSavePath.java:362)
	at com.bruce.plugin.actions.MainAction.actionPerformed(MainAction.java:46)
